...
::: {.column width="50%"}
::: incremental
-   With an increasing use of data to make decisions, Statistics has been essential for processing large amounts of data to bite-size information
...
::: {.column width="50%"}
::: fragment
![](https://media.tenor.com/x5dpKrM1U6oAAAAd/vamonos-lets-go.gif){fig-alt="An image showing the Monte Carlo car pulling out from a garage." fig-align="center" width="377"}
:::
:::
...
![Shows Kakashi stopping the fight between Naruto and Sasuke](https://media.tenor.com/Y5I9Ikv8C60AAAAC/kakashi-naruto.gif){fig-align="center"}
:::
:::
:::
