...
[CSU Channel Islands](https://www.csuci.edu){.btn-action-primary .btn-action .btn .btn-success role="button"} [Orcid](https://orcid.org/0000-0002-1137-4310){.btn-action-primary .btn-action .btn .btn-success role="button"}

*All official inquiries come from my official CSUCI email account.*
