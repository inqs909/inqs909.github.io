...
To install Positron, go to their [website](https://positron.posit.co) and click on [get started](https://positron.posit.co/start.html). Afterwards, follow the instructions to prepare your computer to use positron. This involves either installing R from [CRAN](https://cloud.r-project.org/) or Python via [pyenv](https://github.com/pyenv/pyenv) ([Windows](https://github.com/pyenv-win/pyenv-win)). Once that is done, you can navigate to their download [page](https://positron.posit.co/download.html), where you download the appropriate file[^1]. Afterwards, run the installer and follow the prompts. And there you go, Positron should be ready for use.

[^1]: Lucked out they had Fedora.
